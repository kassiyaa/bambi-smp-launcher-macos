# Bambi SMP Launcher for macOS

The official macOS launcher for Bambi SMP — a cozy modded Minecraft survival server.
...
The universal DMG is written to `dist/`. Build and sign it on a Mac before public release.
